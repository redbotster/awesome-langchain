...
- [1Claw](https://github.com/1clawAI/langchain-1claw): LangChain integration for 1Claw — HSM-backed secret tools (get/put/list/rotate), encrypted memory + retriever, multi-chain signing, and workflow automations for agents. Secrets stay vault-side (scoped, audited, revocable) and are never exposed to the model or persisted in context. `pip install langchain-1claw` ![GitHub Repo stars](https://img.shields.io/github/stars/1clawAI/langchain-1claw?style=social)
